...
abstract class FlutterFlowTheme {
  ...
  late Color mediumSlateBlue;
  late Color gamboge;
  late Color whiteSmoke;
  late Color babyPowder;
  late Color eerieBlack;
  late Color night;
  late Color richBlackFOGRA39;
  late Color tropicalIndigo;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color mediumSlateBlue = const Color(0xFF7B78DA);
  late Color gamboge = const Color(0xFFF2A444);
  late Color whiteSmoke = const Color(0xFFF2F2F2);
  late Color babyPowder = const Color(0xFFFFFFFC);
  late Color eerieBlack = const Color(0xFF262626);
  late Color night = const Color(0xFF0D0D0D);
  late Color richBlackFOGRA39 = const Color(0xFF070707);
  late Color tropicalIndigo = const Color(0xFF9592E1);
}
